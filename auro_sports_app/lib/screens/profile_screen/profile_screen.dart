...
import 'package:auro_sports_app/controllers/profile_screen_controller/user_all_address_controller.dart';
import 'package:auro_sports_app/screens/address_manager_screen/address_manager_screen.dart';
  ...
  Widget userDetails() {
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Get.to(() => AddressManagerScreen())!.then((value) {
              userAllAddressController.getUserDetailsFromPrefs();
            });
          },
          child: Text(
