...
import 'package:auro_sports_app/controllers/cart_screen_controller/cart_controller.dart';
import 'package:auro_sports_app/controllers/cart_screen_controller/delete_cart_product_controller.dart';
import 'package:auro_sports_app/screens/checkout_screen/checkout_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../../controllers/cart_screen_controller/add_cart_qty_controller.dart';
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () async {
                                      if(cartController.userCartProductLists[index].cquantity > 1){
                                        ...
                                        await addCartQtyController.getAddProductCartQty(cartQtyDec, cartController.userCartProductLists[index].cartDetailId);
                                        await cartController.getUserDetailsFromPrefs();
                                      }
                                    },
                                    child: Icon(
                                      Icons.remove,
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      await addCartQtyController.getAddProductCartQty(cartQtyInc, cartController.userCartProductLists[index].cartDetailId);
                                      await cartController.getUserDetailsFromPrefs();
                                    },
                                    child: Icon(
                                      Icons.add,
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            await deleteCartProductController.getDeleteProductCart(cartController.userCartProductLists[index].cartDetailId);
                            await cartController.getUserDetailsFromPrefs();
                          },
                          child: Container(
                            child: Padding(
